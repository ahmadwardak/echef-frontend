...
const IngredientCustomizer = ({ servingSize, ingredientsNeeded, addToShoppingCart }) => {
    ...
    function handleIngredientAmount(value, id) {
        ...
        newItems[itemIndex].price = (newItems[itemIndex].basePrice / servingSizeInput.value) * newItems[itemIndex].amount;
    ...
    return (
        <div className='ingredientBox'>
            <div className='servingSizeDiv'>
                ...
                <input type="number" className="servingSizeBox" step="1" min="2"
                    ref={el => { servingSizeInput = el }} defaultValue={ServingSize} onChange={changeServingSize} onKeyDown={preventKeyDown}></input>
            </div>
